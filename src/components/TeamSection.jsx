  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-4">
        ...
        >
          <motion.h2 variants={fadeUpVariants} className="text-4xl md:text-5xl font-bold mb-6 text-white">
            Meet Our Team
          </motion.h2>
          <motion.p variants={fadeUpVariants} className="text-gray-300 text-xl max-w-2xl mx-auto">
            The passionate individuals behind IMS
          </motion.p>
        </motion.div>

        <motion.div className="flex justify-center gap-12" variants={staggerChildren} initial="hidden" animate="visible">
              ...
              <motion.div variants={cardVariants}>
                <Card className="overflow-hidden bg-gray-800/50 backdrop-blur-xl border-gray-700 w-64">
                  <div className="p-6">
                    ...
                    <motion.h3 className="text-xl font-semibold mb-1 text-white" variants={fadeUpVariants}>
                      {member.name}
                    </motion.h3>
                    <motion.p className="text-gray-300" variants={fadeUpVariants}>
                      {member.role}
                    </motion.p>
                  </div>
                </Card>
